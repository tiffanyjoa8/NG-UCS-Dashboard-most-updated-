...
io.on('connection', function(socket){
    ...
    myStreamDeck.on('down', keyIndex => 
    {
        ...
        function reverse(keyIndex, olderkey, oldkey)
        {
            ...
            //if press on parts (should do nothing)
            else if (k==5)
            {
                //do nothing
                therow(1,0,0,0);
        ...
        function therow(rownum, keyIndex, component, part)
        {
            ...
            else if (rownum == 2)
            {
                ...
                // console.log('olderkey1: ' + olderkey)
            ...
            {
                // console.log('hello?')
                // console.log('olderkey2: ' + olderkey)
                ...
                myStreamDeck.on('down', keyIndex =>
                {
                    if (keyIndex == 11)
                    {
                        k = k-1;
                        console.log('will return!')
                        reverse(keyIndex, oldkey, olderkey); //HERE
